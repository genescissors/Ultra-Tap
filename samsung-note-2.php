...
<div class="row-fluid">
        <div class="span12 nav-menus">
            <ul class="nav nav-pills">
                ...
                <li><a href="howto.php">Order</a></li>
            </ul>
        </div>
            ...
            <div class="row-fluid">
                    ...
                    <div class="carousel slide" id="myCarousel">
                        <div class="carousel-inner">
                          <div class="item active">
                            <img alt="" src="static/img/galaxynote2.png">
                          </div>
                          <div class="item">
                            <img alt="" src="static/img/galaxynote2blue.png">
                          </div>
                ...
                <div class="span6 product-detail">
                    ...
                    <p>
                      ...
                      <tr><td><b>Operating System:</b></td>  <td>Android (4.2.2) TouchWiz 4.0 UI</td></tr>
                      <tr><td><b>Weight:</b></td> <td>6.42 oz (182 g)</td></tr>
                      <tr><td><b>Dimensions:</b></td> <td>5.94 x 3.17 x 0.37 inches</td></tr>
                      </table>
                     <br>
                      <table cellpadding = "2" border = "3">
                       <h4>DISPLAY</h4>
                      <tr><td><b>Physical Size:</b></td> <td>5.5 inches</td></tr>
                      <tr><td><b>Resolution:</b></td>  <td>720 x 1280 pixels</td></tr>
                      <tr><td><b>Pixel Density:</b></td> <td>265 ppi</td></tr>
                      ...
                      <table cellpadding = "2" border = "3">
                       <h4>BATTERY</h4>
                      <tr><td><b>Talk Time:</b></td> <td>35.00 hours</td></tr>
                      <tr><td><b>Stand-By Time:</b></td>  <td>40.8 days (370 hours)</td></tr>
                      <tr><td><b>Capacity:</b></td> <td>3100 mAh</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>HARDWARE</h4>
                      <tr><td><b>System Chip:</b></td> <td>Samsung Exynos 4 (4412)</td></tr>
                      <tr><td><b>Processor:</b></td>  <td>Quad Core, 1600 MHz, ARM Cortex A9</td></tr>
