        ...
        <div class="span9">
            ...
            <div class="row-fluid">
                    ...
                    <div class="carousel slide" id="myCarousel">
                        <div class="carousel-inner">
                          <div class="item active">
                            <img alt="" src="static/img/one.png">
                          </div>
                          <div class="item">
                            <img alt="" src="static/img/htconered.png">
                          </div>
                          <div class="item">
                            <img alt="" src="static/img/htconeblack.png">
                          </div>
                          <div class="item">
                            <img alt="" src="static/img/htconewhite.png">
                          </div>
                ...
                <div class="span6 product-detail">
                    <h3>HTC One</h3>
                    <p>
                      <h3>Samsung Galaxy Note 2</h3>
                    <p>
                      <table cellpadding = "2" border = "3">
                      <h4>DESIGN</h4>
                      <tr><td><b>Device Type:</b></td> <td>Smart Phone</td></tr>
                      <tr><td><b>Operating System:</b></td>  <td>Android (4.2.2) Sense 5.0 UI</td></tr>
                      <tr><td><b>Weight:</b></td> <td>5.04 oz (143 g)</td></tr>
                      <tr><td><b>Dimensions:</b></td> <td>5.41 x 2.69 x 0.37 inches</td></tr>
                      </table>
                     <br>
                      <table cellpadding = "2" border = "3">
                       <h4>DISPLAY</h4>
                      <tr><td><b>Physical Size:</b></td> <td>4.7 inches</td></tr>
                      <tr><td><b>Resolution:</b></td>  <td>1080 x 1920 pixels</td></tr>
                      <tr><td><b>Pixel Density:</b></td> <td>468 ppi</td></tr>
                      ...
                      <table cellpadding = "2" border = "3">
                       <h4>BATTERY</h4>
                      <tr><td><b>Capacity:</b></td> <td>2300 mAh</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>HARDWARE</h4>
                      <tr><td><b>System Chip:</b></td> <td>Qualcomm Snapdragon 600 APQ8064T</td></tr>
                      <tr><td><b>Processor:</b></td>  <td>Quad Core, 1700 MHz, Krait 300</td></tr>
                      ...
                      <tr><td><b>Storage Expansion:</b></td> <td>26 GB</td></tr>
                      <br>
                      </table>
                      <table cellpadding = "2" border = "3">
                       <h4>CAMERA</h4>
