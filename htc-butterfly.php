            ...
            <div class="row-fluid">
                    ...
                    <div class="carousel slide" id="myCarousel">
                        <div class="carousel-inner">
                          <div class="item active">
                            <img alt="" src="static/img/butterflyred.png">
                          </div>
                          ]
                          <div class="item">
                            <img alt="" src="static/img/butterflywhite.png">
                          </div>
                ...
                <div class="span6 product-detail">
                    ...
                    <p>
                      ...
                      <tr><td><b>Operating System:</b></td>  <td>Android (4.2.2, 4.1.1) Sense 5 UI</td></tr>
                      <tr><td><b>Weight:</b></td> <td>4.94 oz (140 g)</td></tr>
                     ...
                     <br>
                      ...
                      <table cellpadding = "2" border = "3">
                       <h4>BATTERY</h4>
                      <tr><td><b>Capacity:</b></td> <td>2020 mAh</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>HARDWARE</h4>
                      <tr><td><b>System Chip:</b></td> <td>Qualcomm Snapdragon S4 Pro APQ8064</td></tr>
                      <tr><td><b>Processor:</b></td>  <td>Quad Core, 1500 MHz, Krait</td></tr>
