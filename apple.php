        ...
        <div class="container">
          ...
          <div class="nav-collapse">
            <ul class="nav pull-right">
              <li><a href="products.php" class="disabled">Products</a></li>
...
<div class="row-fluid">
      ...
      <!-- Apple Product Complete -->
      <div class="row-fluid">
        <div class="span12">
            <div class="page-header">
                <h1> <a href="">Apple<small></small></a></h1>
            ...
            <div class="row-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Apple<span class="divider"></span></li>
                </ul>
            </div>
        </div>
      </div>
      ...
      <div class="row-fluid">
        <ul class="thumbnails">
            <li class="span3">
              <div class="thumbnail">
                <a href="product_detail.php"><img alt="" src="static/img/iphone5s.png"></a>
                <div class="caption">
                  <h5>IPhone 5S</h5>
                  <p>PHP 24,999.99</p>
                  <p>Available</p>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a href="product_detail.php"><img alt="" src="static/img/iphone5c.png"></a>
                <div class="caption">
                  <h5>IPhone 5C</h5>
                  <p>PHP 38,500.00</p>
                  <p>Available</p>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a href="product_detail.php"><img alt="" src="static/img/iphone5.png"></a>
                <div class="caption">
                  <h5>IPhone 5</h5>
                  <p>PHP 27,999.00</p>
                  <p>Available</p>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a href="product_detail.php"><img alt="" src="static/img/ipadretinablack.png"></a>
                <div class="caption">
      ...
      <div class="row-fluid">
        <ul class="thumbnails">
            <li class="span3">
              <div class="thumbnail">
                <a href="product_detail.php"><img alt="" src="static/img/ipadminiblack.png"></a>
                <div class="caption">
                  <h5>IPad Mini</h5>
                  <p>PHP 24,999.99</p>
                  <p>Available</p>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a href="product_detail.php"><img alt="" src="static/img/ipadshuffle.png"></a>
                <div class="caption">
                  <h5>IPod Shuffle</h5>
                  <p>PHP 31,999.99</p>
                  <p>Available</p>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a href="product_detail.php"><img alt="" src="static/img/ipadnano7thgen.png"></a>
                <div class="caption">
                  <h5>IPad Nano 7th Gen</h5>
                  <p>PHP 16,999.99</p>
                  <p>Available</p>
                </div>
              </div>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a href="product_detail.php"><img alt="" src="static/img/iphone4s.png"></a>
                <div class="caption">
                  <h5>IPhone 4s</h5>
                  <p>PHP 28,999.99</p>
                  <p>Available</p>
