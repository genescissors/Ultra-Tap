        ...
        <div class="span9">
            <div class="row-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Samsung Galaxy S4 Active</li>
                </ul>
            </div>
            <div class="row-fluid">
                    ...
                    <div class="carousel slide" id="myCarousel">
                        <div class="carousel-inner">
                          <div class="item active">
                            <img alt="" src="static/img/galaxys4active.png">
                          </div>
                ...
                <div class="span6 product-detail">
                    ...
                    <table cellpadding = "2" border = "3">
                      ...
                      <tr><td><b>Weight:</b></td> <td>5.33 oz (151   g)</td></tr>
                     ...
                     <br>
                      ...
                      <tr><td><b>Pixel Density:</b></td> <td>443 ppi</td></tr>
                      ...
                      <tr><td><b>Stand-By Time:</b></td>  <td>12.1 days (320 hours)</td></tr>
                      ...
                      <tr><td><b>Processor:</b></td>  <td>Quad Core, 1900 MHz, ARM Cortex A9</td></tr>
                      <tr><td><b>Graphics Processor:</b></td> <td>PowerVR SGX543MP3</td></tr>
                      <tr><td><b>System Memory:</b></td> <td>Adreno 320</td></tr>
                      <tr><td><b>Built-in Storage:</b></td> <td>2048 GB</td></tr>
                      ...
                      <table cellpadding = "2" border = "3">
                       <h4>CONNECTIVITY</h4>
                      <tr><td><b>Bluetooth:</b></td> <td>8</td></tr>
