        ...
        <div class="span9">
            <div class="row-fluid">
                <ul class="breadcrumb">
                    ...
                    <li><a href="htc.php">HTC</a> <span class="divider">/</span></li>
                    <li class="active">HTC Desire 200</li>
                </ul>
            </div>
            <div class="row-fluid">
                    ...
                    <div class="carousel slide" id="myCarousel">
                        <div class="carousel-inner">
                          <div class="item active">
                            <img alt="" src="static/img/desire200.png">
                          </div>
                          <div class="item">
                            <img alt="" src="static/img/desire200white.png">
                          </div>
                          
                                                 
                        </div>
                        <a class="left carousel-control" href="#myCarousel"ata-slide="prev">&lsaquo;</a>
                        <a class="right carousel-control" href="#myCarousel" data-slide="next">&rsaquo;</a>
                      </div>
                </div>
                <div class="span6 product-detail">
                    <h3>HTC Desire 200</h3>
                    <p>
                      <table cellpadding = "2" border = "3">
                      <h4>DESIGN</h4>
                      <tr><td><b>Device Type:</b></td> <td>Smart Phone</td></tr>
                      <tr><td><b>Operating System:</b></td>  <td>Android (4.0) Sense UI</td></tr>
                      <tr><td><b>Weight:</b></td> <td>3.53 oz (100 g)</td></tr>
                      <tr><td><b>Dimensions:</b></td> <td>4.24 x 2.39 x 0.47 inches</td></tr> 
                      </table>
                     <br>
                      <table cellpadding = "2" border = "3">
                       <h4>DISPLAY</h4>
                      <tr><td><b>Physical Size:</b></td> <td>3.5 inches</td></tr>
                      <tr><td><b>Resolution:</b></td>  <td>320 x 480 pixels</td></tr>
                      <tr><td><b>Pixel Density:</b></td> <td>165 ppi</td></tr>
                      <tr><td><b>Touchscreen:</b></td> <td>Multi- touch</td></tr>
                      <tr><td><b>Features:</b></td> <td>Light Sensor, Proximitz Sensor</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>BATTERY</h4>
                      <tr><td><b>Talk Time:</b></td> <td>10.90 hours</td></tr>
                      <tr><td><b>Stand by Time:</b></td>  <td>28.9 days 693 hours</td></tr>
                      <tr><td><b>Capacity:</b></td> <td>1230 mAh</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>HARDWARE</h4>
                      <tr><td><b>System Chip:</b></td> <td>Squalcomm Snapdragon S1</td></tr>
                      <tr><td><b>Processor:</b></td>  <td>Single Core, 1000 MHz</td></tr>
                      <tr><td><b>Graphics Processor:</b></td> <td>Yes</td></tr>
                      <tr><td><b>System Memory:</b></td> <td>512 MB RAM</td></tr>
                      <tr><td><b>Storage Expansion:</b></td> <td>microSD, microSDHC up to 32 GB</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>CAMERA</h4>
                      <tr><td><b>Camera:</b></td> <td>5 Megapixels</td></tr>
                      <tr><td><b>Camcorder:</b></td>  <td>640 x 480</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>MULTIMEDIA</h4>
