            ...
            <div class="row-fluid">
                    ...
                    <div class="carousel slide" id="myCarousel">
                        <div class="carousel-inner">
                          <div class="item active">
                            <img alt="" src="static/img/iphone5.png">
                          </div>
                          <div class="item">
                            <img alt="" src="static/img/iphone5black.png">
                          </div>
                          <div class="item">
                            <img alt="" src="static/img/iphone5white.png">
                          </div>                         
                        </div>
                ...
                <div class="span6 product-detail">
                    ...
                    <p>
                      ...
                      <tr><td><b>Dimensions:</b></td> <td>4.87 x 2.31 x 0.30 inches</td></tr>
                      <tr><td><b>Body Material:</b></td> <td>Aluminum</td></tr>
                      </table>
                     <br>
                      <table cellpadding = "2" border = "3">
                       <h4>DISPLAY</h4>
                      ...
                      <table cellpadding = "2" border = "3">
                       <h4>BATTERY</h4>
                      <tr><td><b>Talk Time:</b></td> <td>8.00 hours</td></tr>
                      <tr><td><b>Stand-By Time:</b></td>  <td>9.4 days (225 hours)</td></tr>
                      <tr><td><b>Capacity:</b></td> <td>1440 mAh</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>HARDWARE</h4>
                      <tr><td><b>System Chip:</b></td> <td>Apple A6</td></tr>
                      <tr><td><b>Processor:</b></td>  <td>Dual Core, 1300 MHz, Apple Swift</td></tr>
