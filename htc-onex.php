            ...
            <div class="row-fluid">
                    ...
                    <div class="carousel slide" id="myCarousel">
                        <div class="carousel-inner">
                          <div class="item active">
                            <img alt="" src="static/img/onex.png">
                          </div>
                          <div class="item">
                            <img alt="" src="static/img/htconex.png">
                          </div>
                ...
                <div class="span6 product-detail">
                    ...
                    <p>
                      ...
                      <tr><td><b>Operating System:</b></td>  <td>Android (4.2.2, 4.1, 4.0.4, 4.0.3) Sense 4 UI</td></tr>
                      <tr><td><b>Weight:</b></td> <td>4.59 oz (130 g)</td></tr>
                      <tr><td><b>Dimensions:</b></td> <td>5.29 x 2.75 x 0.31 inches</td></tr>
                      </table>
                     <br>
                      <table cellpadding = "2" border = "3">
                       <h4>DISPLAY</h4>
                      ...
                      <tr><td><b>Pixel Density:</b></td> <td>312 ppi</td></tr>
                      ...
                      <table cellpadding = "2" border = "3">
                       <h4>BATTERY</h4>
                      <tr><td><b>Capacity:</b></td> <td>1800 mAh</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>HARDWARE</h4>
                      <tr><td><b>System Chip:</b></td> <td>NVIDIA Tegra 3 T30</td></tr>
                      <tr><td><b>Processor:</b></td>  <td>Quad Core, 1500 MHz, ARM Cortex-A9</td></tr>
                      <tr><td><b>Graphics Processor:</b></td> <td>ULP GeForce @520MHz </td></tr>
                      ...
                      <tr><td><b>Camcorder:</b></td>  <td>1920 x 1080 (1080HD) (23fps)</td></tr>
                      <tr><td><b>Front-facing camera:</b></td> <td>1.3 Megapixels</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>MULTIMEDIA</h4>
