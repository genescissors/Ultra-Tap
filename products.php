...
<div class="row-fluid">
      ...
      <div class="row-fluid">
        <div class="span12">
            <div class="page-header">
                <h1> <a href="samsung.php">Samsung<small></small></a></h1>
            </div>
        </div>
      </div>
      ...
      <div class="row-fluid">
        <ul class="thumbnails">
            ...
            <li class="span3">
              <div class="thumbnail">
                <a href="samsung-grand.php"><img alt="" src="static/img/galaxygrand.png"></a>
                <div class="caption">
                  <h5>Samsung Galaxy Grand</h5>
                  <p>PHP 12,780.00</p>
                  <p>Available</p>
                </div>
              </div>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a href="galaxy-pocket-neo.php"><img alt="" src="static/img/galaxypocketneo.png"></a>
                <div class="caption">
                  <h5>Samsung Galaxy Pocket Neo</h5>
                  <p>PHP 4,750.00</p>
                  <p>Available</p>
                </div>
              </div>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a href="samsung-galaxy-frame.php"><img alt="" src="static/img/galaxyframe.png"></a>
                <div class="caption">
                  <h5>Samsung Galaxy Fame</h5>
                  <p>PHP 8,790.00</p>
                  <p>Available</p>
                </div>
              </div>
...
<!--Apple Products-->
      <div class="row-fluid">
        <div class="span12">
            <div class="page-header">
                <h1><a href="apple.php">Apple</a><small></small></h1>
            </div>
        </div>
      </div>
      ...
      <div class="row-fluid">
        <ul class="thumbnails">
            ...
            <li class="span3">
              <div class="thumbnail">
                <a href="ipad-4th-gen.php"><img alt="" src="static/img/ipadretinablack.png"></a>
                <div class="caption">
                  <h5>IPad 4th Gen Retina Display</h5>
                  <p>PHP 25,350.00</p>
                  <p>Available</p>
                </div>
              </div>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a href="ipad-mini.php"><img alt="" src="static/img/ipadminiblack.png"></a>
                <div class="caption">
                  <h5>IPad Mini</h5>
                  <p>PHP 15,500.00</p>
                  <p>Available</p>
...
<!--HTC Products-->
      <div class="row-fluid">
        <div class="span12">
            <div class="page-header">
                <h1><a href="htc.php">HTC</a><small></small></h1>
            </div>
        </div>
      </div>
      ...
      <div class="row-fluid">
        <ul class="thumbnails">
            <li class="span3">
              <div class="thumbnail">
                <a href="htc-butterfly.php"><img alt="" src="static/img/butterflyred.png"></a>
                <div class="caption">
                  <h5>HTC Butterfly</h5>
                  <p>PHP 21,180.00</p>
                  <p>Available</p>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a href="htc-butterfly-s.php"><img alt="" src="static/img/butterflyswhite.png"></a>
                <div class="caption">
                  <h5>HTC Butterfly S</h5>
                  <p>PHP 28,000.00</p>
                  <p>Available</p>
                </div>
              </div>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a href="htc-desire-200.php"><img alt="" src="static/img/desire200.png"></a>
                <div class="caption">
                  <h5>HTC Desire 200</h5>
                  <p>PHP 14,400.00</p>
                  <p>Available</p>
                </div>
              </div>
