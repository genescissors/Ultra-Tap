        ...
        <div class="span9">
            <div class="row-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Samsung Galaxy Fame</li>
                </ul>
            </div>
            <div class="row-fluid">
                    ...
                    <div class="carousel slide" id="myCarousel">
                        <div class="carousel-inner">
                          <div class="item active">
                            <img alt="" src="static/img/galaxyframe.png">
                          </div>
                          
                          <div class="item">
                            <img alt="" src="static/img/galaxyframeblue.png">
                          </div>
                ...
                <div class="span6 product-detail">
                    ...
                    <p>
                      ...
                      <tr><td><b>Weight:</b></td> <td>4.25 oz (121 g)</td></tr>
                      <tr><td><b>Dimensions:</b></td> <td>4.46 x 2.43 x 0.46 inches</td></tr>
                      </table>
                     <br>
                      <table cellpadding = "2" border = "3">
                       <h4>DISPLAY</h4>
                      ...
                      <tr><td><b>Camcorder:</b></td>  <td>640 x 480 (VGA) (25fps)</td></tr>
                      <tr><td><b>Front-facing camera:</b></td> <td>0.3 Megapixels VGA</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>MULTIMEDIA</h4>
                      ...
                      <tr><td><b>Wi-Fi:</b></td>  <td>Yes</td></tr>
                      </table>                    
                    </p>
                    <p><h2>PHP 8,790.00</h2></p>
                    <p>
