        ...
        <div class="span9">
            <div class="row-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="active">HTC Butterfly</li>
                </ul>
            </div>
            <div class="row-fluid">
                    ...
                    <div class="carousel slide" id="myCarousel">
                        <div class="carousel-inner">
                          <div class="item active">
                            <img alt="" src="static/img/butterflysred.png">
                          </div>
                          <div class="item">
                            <img alt="" src="static/img/butterflysgray.png">
                          </div>
                          <div class="item">
                            <img alt="" src="static/img/butterflyswhite.png">
                          </div>
                ...
                <div class="span6 product-detail">
                    <h3>HTC Butterfly S</h3>
                    <p>
                      <table cellpadding = "2" border = "3">
                      <h4>DESIGN</h4>
                      <tr><td><b>Device Type:</b></td> <td>Smart Phone</td></tr>
                      <tr><td><b>Operating System:</b></td>  <td>Android (4.1) Sense 5.0 UI</td></tr>
                      <tr><td><b>Weight:</b></td> <td>5.64 oz (160 g)</td></tr>
                      <tr><td><b>Dimensions:</b></td> <td>5.69 x 2.78 x 0.42 inches</td></tr> 
                      </table>
                     <br>
                      <table cellpadding = "2" border = "3">
                       <h4>DISPLAY</h4>
                      ...
                      <tr><td><b>Features:</b></td> <td>Light Sensor, Proximity Sensor, Scratch-resistant</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>BATTERY</h4>
                      <tr><td><b>Talk Time:</b></td> <td>29.00 hours</td></tr>
                      <tr><td><b>Stand-by Time:</b></td>  <td>22.7 days (544 hours)</td></tr>
                      <tr><td><b>Capacity:</b></td> <td>3200 mAh</td></tr>
                      </table>
                      <BR>
                      <table cellpadding = "2" border = "3">
                       <h4>HARDWARE</h4>
                      <tr><td><b>System Chip:</b></td> <td>Qualcomm Snapdragon 600</td></tr>
                      <tr><td><b>Processor:</b></td>  <td>Quad Core, 1900 MHz, Krait 300</td></tr>
                      <tr><td><b>Graphics Processor:</b></td> <td>Adreno 320</td></tr>
                      ...
                      <table cellpadding = "2" border = "3">
                       <h4>CAMERA</h4>
                      <tr><td><b>Camera:</b></td> <td>4 Megapixels</td></tr>
                      ...
                      <tr><td><b>Speakers:</b></td>  <td>Earpiece, Stereo Speaker</td></tr>
