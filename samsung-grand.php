        ...
        <div class="span9">
            <div class="row-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Samsung Galaxy Grand</li>
                </ul>
            </div>
            <div class="row-fluid">
                <div class="span6 product">
                    <div class="carousel slide" id="myCarousel">
                        <div class="carousel-inner">
                          <div class="item">
                            <img alt="" src="static/img/galaxygrand.png">
                          </div>
                          <div class="item active">
                            <img alt="" src="static/img/galaxygrandwhite.png">
                          </div>
                ...
                <div class="span6 product-detail">
                    ...
                    <p>
                      ...
                      <tr><td><b>Weight:</b></td> <td>5.71 oz (162 g)</td></tr>
                      <tr><td><b>Dimensions:</b></td> <td>5.65 x 3.03 x 0.38 inches</td></tr>
                      </table>
                     <br>
                      <table cellpadding = "2" border = "3">
                       <h4>DISPLAY</h4>
                      <tr><td><b>Physical Size:</b></td> <td>5.0 inches</td></tr>
                      <tr><td><b>Resolution:</b></td>  <td>480 x 800 pixels</td></tr>
                      ...
                      <table cellpadding = "2" border = "3">
                       <h4>BATTERY</h4>
                      <tr><td><b>Talk time:</b></td> <td>10.16 hours</td></tr>
                      <tr><td><b>Stand-by time:</b></td> <td>18.3 days (440 hours)</td></tr> 
                      <tr><td><b>Capacity:</b></td> <td>2100 mAh</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>HARDWARE</h4>
                      <tr><td><b>Processor:</b></td>  <td>Dual Core, 1200 MHz</td></tr>
                      ...
                      <tr><td><b>Storage Expansion:</b></td> <td>microSD, microSDHC, microSDXC up to 64GB</td></tr>
                      </table>
                      <br>
                      <table cellpadding = "2" border = "3">
                       <h4>CAMERA</h4>
                      <tr><td><b>Camera:</b></td> <td>8 Megapixels</td></tr>
                      <tr><td><b>Camcorder:</b></td>  <td>1920 x 1080 (1080p HD)</td></tr>
